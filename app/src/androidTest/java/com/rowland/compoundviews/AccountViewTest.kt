...
import com.rowland.compoundviews.ui.MockActivity
...
class AccountViewTest {
    ...
    fun testLoggedOut() {
        ...
        onView(withId(R.id.text_name)).check(matches(withText(R.string.account_name_logged_out)))
        onView(withId(R.id.image_activated_badge)).check(matches(not(isDisplayed())))
    }
    ...
    fun testActivationPending() {
        ...
        onView(withId(R.id.text_name)).check(matches(withText(accountActivationPending.name)))
        onView(withId(R.id.image_activated_badge)).check(matches(isDisplayed()))
    }
    ...
    fun testActivationMissing() {
        ...
        onView(withId(R.id.text_name)).check(matches(withText(accountActivationMissing.name)))
        onView(withId(R.id.image_activated_badge)).check(matches(isDisplayed()))
    }
    ...
    fun testActivationDone() {
        ...
        onView(withId(R.id.text_name)).check(matches(withText(accountActivationDone.name)))
        onView(withId(R.id.image_activated_badge)).check(matches(not(isDisplayed())))
    }
